  ...
  return (
    <div className="bg-slate-50">
      <section>
        ...
        sm:pb-32 lg:gap-x-0 xl:gap-x-9 lg:pt-24 xl:pt-32 lg:pb-52 ">
          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            ...
            flex flex-col items-center lg:items-start">
              ...
              lg:text-left text-balance md:text-wrap">
                Capture your favorite memories with your own, <span
      ...
      <section className="bg-slate-100 py-24">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          ...
          sm:gap-6">
            ...
            text-balance !leading-tight fond-bold text-5xl md_text-6xl
            text-gray-900">
              What our {""}<span className="relative px-2">
                customers{""} <Icons.underline className="hidden sm:block pointer-events-none
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  design. Had the case for two and half honths now and 
                  <span className="p-0.5 bg-slate-800 text-white">the image is super clear</span>, on the case i
                  had before, the image started fading into yellow-ish color
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  looks brand new after about half a year</span>. I dig it.
                </p>
              </div>
              <div className="flex gap-4 mt-2">
                <img className="rounded-full h-12 w-12 object-cover"
